...
function makeBackendRequest(query, year) {
  const apiUrl = `https://api.themoviedb.org/3/search/movie?api_key=3e1aa277fd6b8a3cd0a3e29dfce20a5c&query=${encodeURIComponent(query)}&include_adult=false&language=en-US&page=1&year=${year}`;
